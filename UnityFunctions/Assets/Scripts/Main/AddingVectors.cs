...
namespace Main
{
    ...
    public class AddingVectors : BaseMainScript
    {
        ...
        void Start ()
        {
            ...
            _cFrom = fun.meshes.CreateSphere(new DtSphere {radius = sphereRadius}).SetName("C_From").SetStandardShaderTransparentColor(1, 0, 1, 1).transform;
